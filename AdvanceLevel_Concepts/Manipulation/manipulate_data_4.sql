...
--username Administrator --password venkat \
--set \
--rbac-username deleteonly \
--rbac-password venkat \
...
cd /Users/venkat/Library/Application\ Support/Couchbase/var/lib/couchbase/data
