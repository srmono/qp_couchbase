...
curl -X PUT \
-H "Content-Type: application/json" http://Administrator:venkat@127.0.0.1:8092/student-sample/_design/dev_rest_view \
...
curl -v -X DELETE \
http://Administrator:venkat@127.0.0.1:8092/student-sample/_design/dev_rest_view
